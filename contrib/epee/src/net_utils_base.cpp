...
namespace epee { namespace net_utils
{
	...
	{ return string_tools::get_ip_string_from_int32(ip()) + ":" + std::to_chars(port()); }
	...
	{ return std::string("[") + host_str() + "]:" + std::to_chars(port()); }
	...
	{ return string_tools::get_ip_string_from_int32(subnet()) + "/" + std::to_chars(m_mask); }

	std::string ipv4_network_subnet::host_str() const { return string_tools::get_ip_string_from_int32(subnet()) + "/" + std::to_chars(m_mask); }
