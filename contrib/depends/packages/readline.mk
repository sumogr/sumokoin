...
define $(package)_set_vars
  ...
  $(package)_config_env_darwin=RANLIB="$(host_prefix)/native/bin/x86_64-apple-darwin15-ranlib" AR="$(host_prefix)/native/bin/x86_64-apple-darwin15-ar" CC="$(host_prefix)/native/bin/$($(package)_cc)"
  $(package)_config_opts+=--prefix=$(host_prefix)
  $(package)_config_opts+=--exec-prefix=$(host_prefix)
  $(package)_config_opts+=--host=$(HOST)
  $(package)_config_opts+=--disable-shared --with-curses
  $(package)_config_opts_release=--disable-debug-mode
  $(package)_config_opts_darwin+=RANLIB="$(host_prefix)/native/bin/x86_64-apple-darwin15-ranlib" AR="$(host_prefix)/native/bin/x86_64-apple-darwin15-ar" CC="$(host_prefix)/native/bin/$($(package)_cc)"
